    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 marb20">
          ...
          <h3 class="cnt-ttl" align="center">Invia dati come laboratorio</h3>
		  
           <div id="privata">
			 <div class="form-group" align="center"><br>		   
			    <form id="regForm" method="post" action="inviaDatiLab.php" role="form">
  
                 <div class="form-group"><strong style="color: black">Inserisci codice laboratorio*</strong><br><br>
			       <input type="text" class="form-control br-radius-zero" name="codice_univoco" id="codice_univoco" title="Il codice univoco è composto da 12 cifre alfanumeriche." placeholder="Codice laboratorio*" required maxlength="12" data-msg="Inserisci un codice valido"/>
