      ...
      <div class="col-md-4 col-sm-4">
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
             <h3 class="ser-title" align="center">Disponibilità laboratorio</h3>
            <div class="space"></div>

  
<form action="dateAmm.php" role="form" class="contactForm" method="POST" align="center"><br>
<strong style="color: black">Per una maggiore sicurezza reinserisci il codice univoco del laboratorio</strong><br><br>
  <input type="text" class="form-control br-radius-zero" required placeholder="Es. AA1AB2AB1BAA" name="codice_lab"><br><br>
  <strong style="color: black">Inserisci disponibilità</strong><br>
  <input type="datetime-local" class="form-control br-radius-zero" required name="dataDisp"><br><br>
