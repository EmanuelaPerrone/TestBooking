...
<body id="myPage">
 ...
 <section id="contact" class="section-padding">
	...
	<!-- FORM PER TERZI -->
	<div id="checkNumeroTamponi" align="center">
	 <select id="num_tamp" onchange="javascript:handleSelect(this)">
	 <option selected disabled value="Seleziona numero tamponi">Seleziona numero tamponi</option>
