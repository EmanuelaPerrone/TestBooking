...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
 ...
 <section id="contact" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="ser-title">AREA PRIVATA - INVIA DATI AGLI enti esterni</h2>
          <hr class="botm-line">
        </div>
 ...
 <div id="invioDati">
  <form name="form" method="post" action="ok.php"> 
 <div class="form-group" align="center"><strong style="color: black">Dati degli ultimi</strong>
  <input type="number" name="range" min="1" max="365" value="1" step="1"><strong style="color: black"> giorni</strong><br><br>
