  ...
  $conn = new mysqli($host, $user, $pass, $db);
	if ($conn->connect_error) {
      die("Connessione al database fallita: " . $conn->connect_error);
		...
		$codice_conferma = strtoupper($a);
		
		$query = "INSERT INTO amministrazione (email, codice_conferma) VALUES ('$pec', '$codice_conferma')";
...
//----------Email-------------------------------------------------------------------------------------------------------------------------------------------- 
		...
		$mail_oggetto = "Codice di conferma - Azienda Sanitaria";
		$mail_corpo = "Hai richiesto il codice di conferma per richiedere dati come Azienda sanitaria: 
	
PEC azienda sanitaria: $pec;
Codice di conferma: $codice_conferma.
...
?>
              ...
              <div id="codice">
			   <form name="form" method="post" action="datiAzienda.php">
			  <h2><em class="fas fa-envelope"></em> È stato inviato un codice alla tua pec<br><br>Inseriscilo per continuare:</h2>
                 <div class="form-group"><br><br>
			       <input type="text" class="form-control br-radius-zero" name="codice" required id="codice" placeholder="Codice di conferma*" required data-msg="Inserisci un codice valida"/>
