...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
 ...
 <div id="invioDati">
 <form name="form" method="post" action="richiestaAzienda1.php">
 <div class="form-group" align="center"><strong style="color: black">Ricezione dati ogni</strong>
    <input type="number" name="range" min="0" max="365" value="0" step="1"><strong style="color: black"> giorni</strong><br><br>
