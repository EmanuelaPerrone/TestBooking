...
<head>
  ...
  <title>Test Booking - Esiti tamponi Azienda</title>
...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="row">
          <div class="banner-info" style="padding-top: 100px;">
            ...
            <div class="banner-text text-center">
              <h1 class="white">ESITI TAMPONI COVID-19<br>AZIENDA</h1>
            </div>
  ...
  <section id="testimonial" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="ser-title">Esiti tamponi COVID-19 - Azienda</h2>
          <hr class="botm-line">
        </div>
  ...
  $conn = new mysqli($host, $user, $pass, $db);
	if ($conn->connect_error) {
      die("Connessione al database fallita: " . $conn->connect_error);
		...
		// Recupero i valori
    $iv = $_POST['iva'];
		$ce = $_POST['codice_esiti2'];
	
    $query = "SELECT codice_fiscale,nome,cognome,esito FROM dipendenti WHERE id_azienda = '$iv'";
    ...
    if ($result->num_rows > 0) {
     while($row = $result->fetch_assoc()) {
      echo '<center><p style="color:black; font-size: 130%">➤<strong>Codice fiscale: </strong>' .$row["codice_fiscale"].'<br><br><strong>Nome: </strong>' .$row["nome"].'<br><br><strong>Cognome: </strong>' .$row["cognome"].'<br><br><strong>Esito: </strong>' .$row["esito"].'</p></center><br><br>';  	
     }	 
	}
	 else {
