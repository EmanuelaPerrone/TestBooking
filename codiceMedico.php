      ...
      <div class="col-md-4 col-sm-4">
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
             <h3 class="cnt-ttl" align="center">Prenotazione tampone per i pazienti</h3>
            <div class="space"></div>
<?php
 ...
 $db = "my_testbooking";
  ...
  $conn = new mysqli($host, $user, $pass, $db);
    ...
    $query = "SELECT email FROM medico WHERE codice_esiti = '$codice_univoco'";
  	$result = $conn->query($query);
	
    if ($result->num_rows > 0) {
     while($row = $result->fetch_assoc()) {
      $emailMedico = $row["email"];
	 }
    header("location: https://testbooking.altervista.org/prenotazionePazienti.php?ce=$codice_univoco"); 
	}
	else {
