...
//----------------- Invio email -------------------------------------------------------------------------------------------------------------		 
	  if(mysqli_query($conn, $query)) {
         ...
         echo "<h3>Prenotazione effettuata!<br><br>Verranno inviate delle email agli indirizzi corrispondenti con le indicazioni necessarie.</h3><br><center><button type='button' class='btn btn-primary'><a href='index.php' style='color: white'>Home</font></a></button></center>";
