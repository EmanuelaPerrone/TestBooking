      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
            <h3 class="cnt-ttl" align="center">Richiesta dati</h3>
            <div class="space"></div>
...
<?php 
 ...
 $db = "my_testbooking";
  ...
  $conn = new mysqli($host, $user, $pass, $db);
	...
	$query = "SELECT id FROM amministrazione WHERE codice_conferma = '$codice'";
	$result = mysqli_query($conn, $query);
	 
	 if ($result->num_rows > 0) {
		 echo "<div id='invioDati'><br><center><a href='formaAggregata.php?codice_conferma=$codice' class='btn btn-primary btn-lg btn-block'>Richiedi dati in forma aggregata</a><a href='elencoPositivi.php' class='btn btn-primary btn-lg btn-block'>Richiedi elenco positivi</a></center></div>";
	 } else {
		 echo "<h3>Codice di conferma errato. Riprova. <br><br><center><button type='button' onclick='javascript:history.back()' class='btn btn-primary'>Indietro</button></center></h3>";
	 }
?>
