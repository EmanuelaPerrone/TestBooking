...
<body id="myPage">
        ...
        <div class="container">
          <div class="col-md-12">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#"><img src="img/logo.png" alt="img" alt="img" class="img-responsive" style="width: 140px; margin-top: -16px;"></a>
            </div>
 ...
 <section id="contact" class="section-padding">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
            <h3 class="cnt-ttl" align="center">Stai prenotando il tampone per tre persone.</h3>
  ...
  <form id="regForm" method="post" action="prenotazioniMultiple3.php" role="form" class="contactForm">
...
?>			  
    <div class="form-group"><strong style="color: black">Città laboratorio*</strong><br>
	<select name="citta2" required id="citta2"> 
		...
		?> 
			  ...
			  <div class="form-group"><strong style="color: black">Seleziona data e ora*</strong><br>
			   <select name="data_ora" required id="data_ora7"> 
	          <option selected disabled value="">Seleziona giorno e ora</option> 
	          </select>
              </div>
...
<!-- Terza persona -->
   <div class="terza">
			  ...
			  <div class="form-group"><strong style="color: black">Codice Fiscale del minore*</strong><br>
			   <input type="text" class="form-control br-radius-zero" name="cf_min3" id="cf_min" pattern="^[a-zA-Z]{6}[0-9]{2}[a-zA-Z][0-9]{2}[a-zA-Z][0-9]{3}[a-zA-Z]$" placeholder="Codice fiscale del minore*">
				<div class="validation"></div>
              </div>			  
              <div class="form-group"><strong style="color: black">Nome del minore*</strong><br>
...
                 <label for="8999">No</label><br><br>
			  ...
			  function effettuaPagamento(){
                ...
                var prezzo3 = c3.text;
					...
					confirm("Confermi il pagamento dei tamponi: " + prezzo1 + ", " + prezzo2 + " e " + prezzo3 + " ?");
