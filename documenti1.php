...
<!-- inizio form -->
          <form id="regForm" method="post" action="med.php" role="form" class="contactForm">
   ...
   <div class="tab">
              ...
              <div class="form-group"><strong style="color: black">Nome medico*</strong><br>
                <input type="text" name="nome" class="form-control br-radius-zero" id="nome" placeholder="Nome medico*" data-rule="minlen:3" required data-msg="Controlla questo campo" />
                <div class="validation"></div>
              </div>
              <div class="form-group"><strong style="color: black">Cognome medico*</strong><br>
                <input type="text" class="form-control br-radius-zero" name="cognome" id="cognome" placeholder="Cognome medico*" data-rule="minlen:3" required data-msg="Controlla questo campo" />
                <div class="validation"></div>
              </div>
			  <div class="form-group"><strong style="color: black">Data di nascita medico*</strong><br>
                <input type="date" class="form-control br-radius-zero" name="data_nasc" id="data_nasc" placeholder="Data di nascita medico*" required data-msg="Controlla questo campo" />
                <div class="validation"></div>
              </div>
			  ...
			  <div class="form-group"><strong style="color: black">PEC medico*</strong><br>
                <input type="email" class="form-control br-radius-zero" name="email" id="email" placeholder="PEC medico*" data-rule="email" maxlength="100" required data-msg="Inserisci un'email valida" />
                <div class="validation"></div>
              </div>
			  <div class="form-group"><strong style="color: black">Numero di telefono medico*</strong><br>
                <input type="tel" class="form-control br-radius-zero" name="telefono" id="telefono" placeholder="Numero di telefono*" data-rule="minlen:4" maxlength="10" required data-msg="Inserisci un numero di telefono valido" />
                <div class="validation"></div>
              </div>
