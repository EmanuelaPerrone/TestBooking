...
//----------Email-------------------------------------------------------------------------------------------------------------------------------------------- 
		...
		$mail_mittente = "aziendasanitaria";
		$mail_destinatario = "testbooking19@gmail.com";

		$mail_oggetto = "Richiesta dati - Azienda Sanitaria";
		$mail_corpo = "Son stati richiesti dati dall'Azienda sanitaria: 
	
Ricezione dati ogni $range giorno/i,
Dati richiesti: elenco positivi.";
...
?>
<div id="invioDati" align="center">

  <h2 class="ser-title" style="color: green"><em class="fas fa-check-circle"></em> Dati richiesti correttamente.</font></h2><br>
