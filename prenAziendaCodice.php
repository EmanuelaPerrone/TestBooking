      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
            <h3 class="cnt-ttl" align="center">Inserisci il codice per continuare</h3>

            <div id="codice">
			 <div class="form-group" align="center"><br>		   
			    <form id="regForm" method="post" action="codiceAzienda.php" role="form">
  
                 <div class="form-group"><strong style="color: black">Inserisci codice*</strong><br><br>
			       <input type="text" class="form-control br-radius-zero" name="codice_univoco" id="codice_univoco" title="Il codice univoco è composto da 12 cifre alfanumeriche." placeholder="Codice*" required maxlength="12" data-msg="Inserisci un codice valido"/>
