...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="row">
          <div class="banner-info" style="padding-top: 100px;">
            ...
            <div class="banner-text text-center">
              <h1 class="white">ESITI TAMPONI COVID-19<br>UTENTE</h1>
            </div>
 ...
 <section id="testimonial" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="ser-title">Esiti tamponi COVID-19 - Utente</h2>
          <hr class="botm-line">
        </div>
  ...
  $conn = new mysqli($host, $user, $pass, $db);
	if ($conn->connect_error) {
      die("Connessione al database fallita: " . $conn->connect_error);
		...
		$ce = $_POST['codice_esiti'];
	
    $query = "SELECT codice_fiscale, codice_esiti, esito FROM persona WHERE codice_fiscale = '$cf' AND codice_esiti = '$ce'";
	$result = $conn->query($query);
	
	 echo "<center><h3>La tua prenotazione:</h3></center>";
	
    if ($result->num_rows > 0) {
     while($row = $result->fetch_assoc()) {
	  echo '<br><center><p style="color:black; font-size: 130%">➤<strong>Codice fiscale: </strong>' .$row["codice_fiscale"].'<br><br><strong> Codice esiti: </strong>' .$row["codice_esiti"].'<br><br><strong> Esito: </strong>' .$row["esito"].'</p></center><br>';  	
     }	
	 echo '<br><center><a href="index.php" class="btn btn-primary">Home</a></center>';
	}
	 else {
