      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
            ...
            <div id='azienda' align="center"><br>
            <h3>Se effettui per la prima volta una prenotazione come<br>Datore di lavoro</h3><a href="primaPrenAz.php" class="btn btn-primary">Clicca qui</a>
            <h3>Se sei già in possesso di un codice per prenotare come<br>Datore di lavoro</h3><a href="prenAziendaCodice.php" class="btn btn-primary">Clicca qui</a></div>
           </div>
    </div>
   </div>
  </div>
