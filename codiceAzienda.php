      ...
      <div class="col-md-4 col-sm-4">
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
             <h3 class="cnt-ttl" align="center">Prenotazione tampone per i dipendenti</h3>
            <div class="space"></div>
<?php
 ...
 $db = "my_testbooking";
  ...
  $conn = new mysqli($host, $user, $pass, $db);
    ...
    $query = "SELECT email FROM aziende WHERE codice_esiti = '$codice_univoco'";
  	$result = $conn->query($query);
	
    if ($result->num_rows > 0) {
     while($row = $result->fetch_assoc()) {
      $emailAzienda = $row["email"];
	 }
    header("location: https://testbooking.altervista.org/prenotazioneDipendenti.php?ce=$codice_univoco"); 
	}
	else {
	  echo "<h3 style='font-family: Open Sans'><em class='fas fa-times-circle'></em> Nessuna corrispondenza trovata. Controlla i campi e riprova.</h3><br><center><button type='button' onclick='javascript:history.back()' class='btn btn-primary'>Indietro</button></center>";				 
	}
