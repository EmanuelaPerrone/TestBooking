...
<head>
  ...
  <title>Test Booking - Richiesta dati</title>
...
<section id="contact" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="ser-title">AREA PRIVATA - INVIA DATI</h2>
          <hr class="botm-line">
        </div>
 ...
 <div id="invioDati" align="center">
  ...
  <h2 class="ser-title" style="color:green"><em class="fas fa-check-circle"></em> Dati richiesti correttamente.</h2><br>
