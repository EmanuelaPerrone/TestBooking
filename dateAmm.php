      ...
      <div class="col-md-4 col-sm-4">
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
             <h3 class="ser-title" align="center">Disponibilità laboratorio</h3><br>	
            <div class="space"></div>
<?php
	...
	$codice_univoco = $_POST["codice_lab"];
	$data = $_POST["dataDisp"];
	$query = "INSERT INTO amministrazione (date_disponibili, codice_lab, dati_inviati) VALUES ('$data', '$codice_univoco', 1)";

    
	  // Controllo se la query è avvenuta		 
	  $result = $conn->query($query);
	  if(!$result) {
		  echo "<font face='Open Sans'><h3>Operazione fallita. Errore con la richiesta.</h3></font><br><center><button onclick='javascript:history.back()' class='btn btn-primary'>Indietro</button></center>";				  
	  } else {
          echo '<center><h2 class="ser-title" style="color:green"><em class="fas fa-check-circle"></em> Date inviate correttamente.</h2><br><a href="index.php" class="btn btn-primary">Home</a><br><br><a href="aggiornaDate.php" class="btn btn-primary">Aggiungi un altra data</a></center>';
	  }
