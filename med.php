  ...
  $conn = new mysqli($host, $user, $pass, $db);
	if ($conn->connect_error) {
      die("Connessione al database fallita: " . $conn->connect_error);
	    ...
	    $appartenenza = $_POST['appartenenza'];
		$email = $_POST['email'];
    ...
    $query3 = "INSERT INTO medico (codice_esiti, codice_fiscale, nome, cognome, data_nasc, appartenenza, email, telefono, nome_indirizzo, comune) 
    VALUES ('$codice_esiti', '$codice_fiscale', '$nome', '$cognome', '$data_nasc', '$appartenenza', '$email', '$telefono', '$nome_citta_indirizzo', '$nome_comune')";
    ...
    if (mysqli_query($conn, $query3)) {
           ...
           poter effettuare una o più prenotazioni come medico, dovrai inviare all'indirizzo email <strong><u>testbooking19@gmail.com</u></strong> la copia 
           della tua carta d'identità. Una volta che i dati verranno verificati, riceverai un codice con cui poter 
           prenotare il tampone per tuoi pazienti.</h3>";
