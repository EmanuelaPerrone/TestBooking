...
<head>
  ...
  <title>Test Booking - Area Privata</title>
...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="row">
          <div class="banner-info" style="padding-top: 100px;">
            ...
            <div class="banner-text text-center">
              <h1 class="white">AREA PRIVATA</h1>
            </div>
  ...
  <!-- FINE HOME -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="ser-title">AREA PRIVATA</h2>
          <hr class="botm-line">
        </div>
        ...
        <div class="col-md-8 col-sm-8 marb20">
          ...
          <h3 class="cnt-ttl" align="center">Area privata</h3>
		  
		   <div id="privata">
			 <div class="form-group" align="center"><br>		   			  
			    <a href="datiLaboratorio.php" class="btn btn-primary" style="color:white">Area laboratorio</a><br><br>
			    <a href="datiMedico.php" class="btn btn-primary" style="color:white">Area medico</a><br><br>
			    <a href="richiediAzienda.php" class="btn btn-primary" style="color:white">Area azienda sanitaria</a>
			 </div>
			</div> 
