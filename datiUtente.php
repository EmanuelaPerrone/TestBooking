...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
 ...
 <section id="contact" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="ser-title">AREA PRIVATA - INVIA DATI AGLI UTENTI</h2>
          <hr class="botm-line">
        </div>
      <div class="col-md-4 col-sm-4">
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
             <h3 class="cnt-ttl" align="center">Invio dati</h3>
            <div class="space"></div>

 <div id="invioDati">
  <form name="form" method="post" action="emailUtente.php">
  
 <div class="form-group">
 <h3>Inserisci il codice fiscale utente. L'esito sarà inviato automaticamente se presente nel sistema.</h3><br>
 <strong style="color: black">Codice fiscale utente*</strong><br><input type="text" name="cf1" pattern="^[a-zA-Z]{6}[0-9]{2}[a-zA-Z][0-9]{2}[a-zA-Z][0-9]{3}[a-zA-Z]$" maxlength="16" class="form-control br-radius-zero"><br>
